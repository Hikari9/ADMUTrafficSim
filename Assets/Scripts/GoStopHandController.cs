...
public class GoStopHandController : MonoBehaviour {
	...
	public Gesture.GestureType SWIPE = Gesture.GestureType.TYPESWIPE;
	public float AXIS_RANGE_FOR_GO = 5f;
	public float COUNT_ELAPSED_TIME_CAP = 2;
	public int GO_TARGET_COUNT = 3;
